...
const Header = () => {
  ...
  return (
    ...
    <div className="w-full md:w-[80%]  m-auto py-4 px-4 md:px-0 flex justify-between items-center text-slate-900">
     ...
     {/* MENU */}
     <div className="menu flex justify-center items-center text-2xl" onClick={(e)=>setShowMenu(e=>!e)}>
     <GiHamburgerMenu />
     </div>
    ...
    <div className={`h-full w-full fixed top-0 left-0 flex justify-center items-center bg-[#4b4b4b5f] to-slate-900 duration-300 ${!showMenu? "hidden" : "flex"}`} onClick={(e)=>setShowMenu(e=>!e)}>
